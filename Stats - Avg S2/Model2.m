function [M] = Model2(t,y,vDNAin0)
load('Model2_mpars_avg.mat');
mpar = mpars;
...
dProtein1 = ks1*(vDNAtot/(Km1+vDNAtot)) - kd1*Protein1*(Km3/...
    (vDNAtot+Km3)) - ks_C*vDNAtot*Protein1;
 
dProtein2 = ks2*(vDNAtot/(Km2+vDNAtot)) - kd2*Protein2*(Km4/...
