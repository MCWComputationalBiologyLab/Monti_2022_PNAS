...
% Virus data is 4 time points for 3 MOIs. Total = 45.

% Number of parameters. Three kept constant
P1 = 6; %9
P2 = 8; %11
P3 = 8; %11
P4 = 8; %11
...
% Number of parameters + 1 Three parameters kept constant 
K1 = 7;
K2 = 9;
K3 = 9;
K4 = 9;
...
set(gca,'FontName','Arial','FontSize',18,'xaxislocation','top');
...
% FMatrix = [0,1-p12,1-p13,1-p14,1-p15,1-p16;1-p12,0,0,0,1-p25,0;...
%     1-p13,0,0,0,0,1-p36;1-p14,0,0,0,1-p45,1-p46;1-p15,1-p25,0,...
%     1-p45,0,0;1-p16,0,1-p36,1-p46,0,0];
FMatrix = [1.01,1-p12,1-p13,1-p14,1-p15,1-p16;1-p12,1.01,1.01,1.01,1-p25,1.01;...
    1-p13,1.01,1.01,1.01,1.01,1-p36;1-p14,1.01,1.01,1.01,1-p45,1-p46;1-p15,1-p25,1.01,...
    1-p45,1.01,1.01;1-p16,1.01,1-p36,1-p46,1.01,1.01];
...
FMatrixStrings = [strNA,str12,str13,str14,str15,str16;str12,strNA,strNA,...
    strNA,str25,strNA;str13,strNA,strNA,strNA,strNA,str36;str14,strNA,...
    strNA,strNA,str45,str46;str15,str25,strNA,str45,strNA,strNA;str16,...
    strNA,str36,str46,strNA,strNA];
...
textStrings = strtrim(cellstr(textStrings));
[x, y] = meshgrid(1:6);
hStrings = text(x(:), y(:), FMatrixStrings(:), ...
                'HorizontalAlignment', 'center','FontName','Arial',...
                'FontSize',14);
midValue = mean(get(gca, 'CLim'));
...
set(gca,'XTick',xt,'XTickLabel',xtl,'YTick',yt,'YTickLabel',ytl);
set(gcf,'color','white');
title('F-value (p-value) for model n vs. model m (F-Test)','FontName','Arial',...
