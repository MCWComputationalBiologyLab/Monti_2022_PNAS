...
for i = 1:length(vDNAin0)
    ...
    SumP1s{2,i} = currP1*Protein1Max + currCapsid*CapsidMax + ...
        currParticle*ParticleMax;
    SumP2s{2,i} = currP2*Protein2Max + currParticle*ParticleMax;
end

% Find global max of fitted datasets: MOI = 5 96 hpi
