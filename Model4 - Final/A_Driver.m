...
numPars = 11;  % Number of parameters

% Initial guesses for parameters (order of magnitudes to be appropriate)
p0 = [6E2,9E2,1E-1,5E4,6E2,9E3,1E-1,2.5E4,1E-6,3E-5,1.5E0];
...
p0 = [6E2,9E2,1E-1,5E4,6E2,9E3,1E-1,2.5E4,1E-6,3E-5,1.5E0]; % Initial guess
...
% Calculate corrected AIC for the model based on minimum SSE
SSE = mresids;
Nd = 45; Np = numPars-3+1;
AIC = Nd*log(SSE/Nd) + 2*Np + (2*Np*(Np+1))/(Nd-Np-1);
